...
''';
  static const String breakpoint = '''
...
This Game may contain content not appropriate for all ages, or may not be appropriate for viewing at work: Frequent Violence or Gore, General Mature Content
''';
  static const String readyornot = '''
**Los Sueños**
...
''';
  static const String watchdogs2 = '''
...
**Mature Content Description**
The developers describe the content like this:
Intense Violence, Blood and Gore, Sexual Content, Nudity, Strong Language
''';
  static const String outlast2 = '''
...
''';
  static const String farcry5 = '''
Welcome to Hope County, Montana, the land of the free and brave, but also the home of a fanatical doomsday cult. Stand up to cult leader Joseph Seed and his siblings, the Heralds, to spark the fires of resistance and liberate the besieged community.
...
''';
  static const String dyinglight = '''
...
This Game may contain content not appropriate for all ages, or may not be appropriate for viewing at work: Frequent Violence or Gore, General Mature Content
''';
  static const String dyinglight2 = '''
